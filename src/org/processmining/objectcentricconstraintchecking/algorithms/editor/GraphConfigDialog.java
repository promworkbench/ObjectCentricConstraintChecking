...
public class GraphConfigDialog extends JDialog
{
	...
	public GraphConfigDialog(final mxGraphProperties.GraphType graphType2, String dialogText)
	{
		...
		if ((graphType2 == mxGraphProperties.GraphType.NULL) || (graphType2 == mxGraphProperties.GraphType.SIMPLE_RANDOM_TREE))
		{
		...
		else if (graphType2 == mxGraphProperties.GraphType.ObjToObj) {
			...
			applyButton.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent e)
				{
					...
					generator.getObjToObjGraph(aGraph);
//					mxGraphStructure.setObjToObjGraphStyle(aGraph, false);
					setVisible(false);
					graph.getModel().endUpdate();
				}
			});
		...
		else if (graphType2 == mxGraphProperties.GraphType.ObjToAct) {
			JPanel panel = new JPanel(new GridLayout(5, 1, 4, 4));
			panel.add(new JLabel("Number of nodes"));
			panel.add(numNodesField);
			panel.add(arrowsBox = new JCheckBox("Directed", false));
			...
			applyButton.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent e)
				{
					...
					generator.getObjToActGraph(aGraph);
//					mxGraphStructure.setObjToObjGraphStyle(aGraph, false);
					setVisible(false);
					graph.getModel().endUpdate();
				}
		...
		else if (graphType2 == mxGraphProperties.GraphType.ActToAct) {
			JPanel panel = new JPanel(new GridLayout(5, 1, 4, 4));
			panel.add(new JLabel("Number of nodes"));
			panel.add(numNodesField);
			panel.add(arrowsBox = new JCheckBox("Directed", false));
			...
			applyButton.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent e)
				{
					...
					generator.getActToActGraph(aGraph);
//					mxGraphStructure.setObjToObjGraphStyle(aGraph, false);
					setVisible(false);
					graph.getModel().endUpdate();
				}
		...
		else if (graphType2 == mxGraphProperties.GraphType.ActToActCoref) {
			JPanel panel = new JPanel(new GridLayout(5, 1, 4, 4));
			panel.add(new JLabel("Number of nodes"));
			panel.add(numNodesField);
			panel.add(arrowsBox = new JCheckBox("Directed", false));
			...
			applyButton.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent e)
				{
					...
					generator.getActToActWithCoRefGraph(aGraph);
//					mxGraphStructure.setObjToObjGraphStyle(aGraph, false);
					setVisible(false);
					graph.getModel().endUpdate();
				}
		...
		else if (graphType2 == mxGraphProperties.GraphType.ActToObjCard) {
			JPanel panel = new JPanel(new GridLayout(5, 1, 4, 4));
			panel.add(new JLabel("Number of nodes"));
			panel.add(numNodesField);
			panel.add(arrowsBox = new JCheckBox("Directed", false));
			...
			applyButton.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent e)
				{
					...
					generator.getObjActCardinalityGraph(aGraph);
//					mxGraphStructure.setObjToObjGraphStyle(aGraph, false);
					setVisible(false);
					graph.getModel().endUpdate();
				}
		...
		else if (graphType2 == mxGraphProperties.GraphType.ObjToObjCard) {
			JPanel panel = new JPanel(new GridLayout(5, 1, 4, 4));
			panel.add(new JLabel("Number of nodes"));
			panel.add(numNodesField);
			panel.add(arrowsBox = new JCheckBox("Directed", false));
...
//					mxGraphStructure.setObjToObjGraphStyle(aGraph, false);
		...
		else if (graphType2 == mxGraphProperties.GraphType.RESET_STYLE)
		{
			...
			// setLocationRelativeTo(parent);
				...
				|| (graphType2 == mxGraphProperties.GraphType.DFS_UNDIR) || (graphType2 == mxGraphProperties.GraphType.MAKE_TREE_DIRECTED)
				|| (graphType2 == mxGraphProperties.GraphType.INDEGREE) || (graphType2 == mxGraphProperties.GraphType.OUTDEGREE) || (graphType2 == mxGraphProperties.GraphType.IS_CUT_VERTEX))
		{
			JPanel panel = new JPanel(new GridLayout(1, 2, 4, 4));
			...
			applyButton.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent e)
				{
					...
					else if (graphType2 == mxGraphProperties.GraphType.DFS_DIR)
					{
						...
						mxTraversal.dfs(aGraph, startVertex, new mxGraph.mxICellVisitor()
						{
							@Override
							// simple visitor that prints current vertex
							public boolean visit(Object vertex, Object edge)
			...
			applyButton.addActionListener(new ActionListener()
			{
				...
				public void actionPerformed(ActionEvent e)
				{
					...
					if (graphType2 == mxGraphProperties.GraphType.DIJKSTRA)
					{
						...
						try
						{
							mxTraversal.dijkstra(aGraph, startVertex, endVertex, new mxGraph.mxICellVisitor()
							{
								@Override
								// simple visitor that prints current vertex
								public boolean visit(Object vertex, Object edge)
