...
public class EditorPalette extends JPanel
{
	...
	public EditorPalette(Integer rowNum)
	{
		setBackground(new Color(255, 255, 255));
		setLayout(new GridLayout(0, 1, 0, 20));
		setSize(new Dimension(40,150));
		setMaximumSize(new Dimension(40,150));
		setMinimumSize(new Dimension(40,150));
...
//	}
	...
	public void addActTemplate(final String name, ImageIcon icon, mxCell cell)
	{
		...
		if (icon != null)
		{
			icon = new ImageIcon(icon.getImage().getScaledInstance(80, 80,
					0));
		}
