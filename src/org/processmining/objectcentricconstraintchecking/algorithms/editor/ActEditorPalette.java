...
public class ActEditorPalette extends JPanel
{
	...
	public ActEditorPalette(Integer rowNum)
	{
		setBackground(new Color(255, 255, 255));
		setLayout(new GridLayout(0, 1, 0, 20));
		setSize(new Dimension(40,300));
		setMaximumSize(new Dimension(40,300));
		setMinimumSize(new Dimension(40,300));
...
//		if (icon != null)
//		{
//			icon = new ImageIcon(icon.getImage().getScaledInstance(100, 60,
//					0));
//		}
//
//		final JLabel entry = new JLabel(icon);
//		entry.setPreferredSize(new Dimension(100, 60));
//		entry.setBackground(ActEditorPalette.this.getBackground().brighter());
...
//	}
	...
	public void addActTemplate(final String name, ImageIcon icon, mxCell cell)
	{
		...
		entry.setBackground(new Color(235,238,245));
		entry.setFont(new Font(entry.getFont().getFamily(), 0, 15));
