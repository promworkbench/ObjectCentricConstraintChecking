...
package org.processmining.objectcentricconstraintchecking.algorithms.ocel.occl;
		...
		objPalette.addListener(mxEvent.SELECT, new mxEventSource.mxIEventListener()
		{
			public void invoke(Object sender, mxEventObject evt)
			{
				...
				if (tmp instanceof mxGraphTransferable)
				{
					...
					{
						((org.processmining.objectcentricconstraintchecking.algorithms.ocel.constraint.GraphEditor.CustomGraph) graph).setEdgeTemplate(cell);
					}
				}
			}
		...
		for (String objType: objTypeList) {
			...
			objPalette
					.addObjTemplate(
							objType,
							new ImageIcon(
									org.processmining.objectcentricconstraintchecking.algorithms.ocel.constraint.GraphEditor.class
