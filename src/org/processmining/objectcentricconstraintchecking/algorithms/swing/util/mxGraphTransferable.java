 ...
 */
package org.processmining.objectcentricconstraintchecking.algorithms.swing.util;
		...
		Serializable
{
	 ...
	 *     + "; class=org.processmining.swing.util.mxGraphTransferable");
	 * }
	 ...
	 * <code>
	 * mxGraphTransferable.dataFlavor = new DataFlavor(DataFlavor.javaJVMLocalObjectMimeType
	 *   + "; class=org.processmining.swing.util.mxGraphTransferable", null,
	 *   new org.processmining.swing.util.mxGraphTransferable(null, null).getClass().getClassLoader());
	 * </code>
	 */
	...
	static
	{
		...
		try
		{
			dataFlavor = new DataFlavor(DataFlavor.javaSerializedObjectMimeType
					+ "; class=org.processmining.cachealignment.algorithms.swing.util.mxGraphTransferable");
		}
		catch (ClassNotFoundException e)
		{
