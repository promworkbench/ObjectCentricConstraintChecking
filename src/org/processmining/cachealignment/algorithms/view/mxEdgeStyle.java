...
public class mxEdgeStyle
{
	...
	public static mxEdgeStyleFunction EntityRelation = new mxEdgeStyleFunction()
	{
		...
		/* (non-Javadoc)
		 * @see org.processmining.view.mxEdgeStyle.mxEdgeStyleFunction#apply(org.processmining.view.mxCellState, org.processmining.view.mxCellState, org.processmining.view.mxCellState, java.util.List, java.util.List)
		 */
